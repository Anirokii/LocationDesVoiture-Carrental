    ...
    <body>
        <div class="full-screen">
            <div class="container">
                ...
                <button class="payment-btn" type="button"><img src="images/lock.png" alt="" /><a href="paymentsuccessfulpage/index.php"><b>FINISH AND PAY</b></a></button>
                ...
                <ul class="primary">
                    <li>
                            <a href="http://localhost/carrental/carrental/my-booking.php"><b>BACK</b></a>
                    </li>
                </ul>
                </nav>
                </div>
